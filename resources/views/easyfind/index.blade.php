...
<div class="d-flex flex-column px-5 py-5 gap-5">
    <div class="d-flex flex-column gap-5">
        <div class="d-flex flex-row align-items-center justify-content-center gap-2">
            ...
            <a href="#" class="a-default fc-blue">Ver mais produtos</a>
        </div>
        <div class="d-flex flex-row justify-content-between">
            @foreach($produtos as $produto)
                @component('components.produtos.card', ['produto' => $produto])
                @endcomponent
            @endforeach
        </div>
    </div>
    ...
    <div class="d-flex flex-column gap-5">
        ...
        <div class="d-flex flex-row justify-content-between">
            <div style="background-image: url('/img/institucional/categoria-1.png'); width: 414px; height: 342px;" class="d-flex flex-column justify-content-center align-items-center px-5 gap-2">
                ...
                <a href="" class="a-default bgc-primary text-dark px-5 py-2 w-fit-content br-8">Explorar</a>
            </div>
    ...
    <div class="d-flex flex-column gap-5">
        <div class="d-flex flex-row align-items-center justify-content-center gap-2">
            ...
            <a href="#" class="a-default fc-blue">Ver mais produtos em ofertas</a>
        </div>
